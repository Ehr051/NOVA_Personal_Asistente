...
a = Analysis(
    ...
    hiddenimports=[
        ...
        "nova.core.nova_daemon",
        "nova.core.nova_client",
        "nova.tools.nova_skills",
        "nova.tools.nova_neuro_memory",
        "nova.tools.nova_image",
        "nova.lang.novaesp",
        "nova.lang.nova_voice_stt",
        "nova.platform.adapter",
        "nova.connectors.nova_cerebro",
        "nova.connectors.nova_specialist",
        "nova.connectors.nova_vision",
        "nova.connectors.nova_lsp",
